...
$sql_8="SELECT * FROM `repurchase_payout` WHERE `spid`='$spid' AND `endt`='$_POST[endt]'";
...
$sql8="SELECT * FROM `repurchase_payout`  WHERE `spid`='$_POST[spid]' and `endt`<='$row_8[endt]' GROUP BY `endt`";
$res8=mysqli_query($con,$sql8);
$num8=mysqli_num_rows($res8);

$sql6="SELECT * FROM `repurchase_payout`  WHERE `endt`<='$row_8[endt]' GROUP BY `endt`";
...
<tr>
<td class="left bold-text lbdr" style="padding:5px;">Own Income</td><td class="lbdr rbdr" style="padding:5px;text-align:right;">
<?=$row_8[direct_income]?></td>
</tr>
<tr>
<td class="left bold-text lbdr" style="padding:5px;">Downline Commission</td><td class="lbdr rbdr" style="padding:5px;text-align:right;">
<?=$row_8[downline_income]?></td>
</tr>
...
<?=$row_8[direct_income]+$row_8[downline_income]?></td>
</tr>
</tbody></table>
</td>
<td style="width: 50%" colspan="2">
...
<a href="show_payout3.php">Back</a>
</div>
