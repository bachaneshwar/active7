...
<h1>Payout</h1>
<small>Show Global Tree Payout</small>
</div>
</section>	
<!-- Main content -->
...
<form action="member_payout1.php" method="post" name="newform" onsubmit="return validate_form(this);" >
...
<?php
$sql="SELECT * FROM `global_tree_payout` GROUP BY `endt` ORDER BY `endt` DESC";
