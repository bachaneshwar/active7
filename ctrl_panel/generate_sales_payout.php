...
<h1>Payout</h1>
<small>Generate Sales Payout</small>
</div>
</section>	
...
<i class="fa fa-list"></i> Generate Payout
</div>
</div>
<div class="panel-body">
<form class="col-sm-6" action="sales_payout.php" method="post" name="newform" onsubmit="return validate_form(this);" >




<?
$sql_f_pair="SELECT * FROM `sales_payout` GROUP BY `endt` ORDER BY `endt` DESC";
