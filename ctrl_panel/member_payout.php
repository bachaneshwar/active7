...
$sql_8="SELECT * FROM `payout` WHERE `spid`='$spid' AND `endt`='$_POST[endt]'";
$res_8=mysqli_query($con,$sql_8);
$row_8=mysqli_fetch_array($res_8);
$total_amt=$row_8[direct_amt]+$row_8[pair_amount]+$row_8[repur_amt];
$sql1="select * from `package` where `package_id`='1'";
$res1=mysqli_query($con,$sql1);
$row1=mysqli_fetch_array($res1);

$sql_81="SELECT * FROM `member_fees` WHERE `spid`='$spid' AND `endt`='$_POST[endt]'";
$res_81=mysqli_query($con,$sql_81);
$row_81=mysqli_fetch_array($res_81);
$pack_amt=$row_81[package_fees];

$sql8="SELECT * FROM `payout`  WHERE `spid`='$_POST[spid]' and `endt`<='$row_8[endt]' GROUP BY `endt`";
$res8=mysqli_query($con,$sql8);
$num8=mysqli_num_rows($res8);

$sql6="SELECT * FROM `payout`  WHERE `endt`<='$row_8[endt]' GROUP BY `endt`";
...
<form name="form1" method="post" action="showpayout.php" id="form1">
...
<img src="./Welcome Letter_files/logo.png" id="imgLogo" alt="Logo" style="height:60px;border-width:0px;">
<br>
</td>
...
Period</td>
<td class="align-left">
:&nbsp;<span id="lblStart" class="label"><?=$row_8[stdt]?></span>&nbsp;<b>to</b>&nbsp;<span id="lblEnd" class="label"><?=$row_8[endt]?></span></td>
</tr>
<tr>
<td class="bold-text" style="width: 40%">
<span id="mempayno" class="label">Commission Date</span></td>
<td class="align-left">
:&nbsp;<span id="lblmempay" class="label"><?=$row_8[payout_date]?></span></td>
</tr>
<tr>
<td class="bold-text" style="width: 40%">
<span id="mempayno" class="label"></span></td>
<td class="align-left">
</td>
</tr>
<tr>
...
<tr>
<td class="left bold-text lbdr" style="padding:5px;">Binary Income</td><td class="lbdr rbdr" style="padding:5px;text-align:right;">
<?=$row_8[binary_income]?></td>
</tr>
<tr>
<td class="left bold-text lbdr" style="padding:5px;"></td><td class="lbdr rbdr" style="padding:5px;text-align:right;"><br/></td>
</tr>
<tr>
<td class="left tbdr bold-text bbdr lbdr" style="padding:5px;">Total Income</td><td class="right tbdr lbdr bbdr bold-text" style="padding:5px;text-align:right;"><?=$row_8[binary_income]?></td>
</tr>
</tbody></table>
</td>
<td style="width: 50%" colspan="2">
...
<tr>
<td class="left bold-text" style="padding:5px;">TDS Charge</td><td class="lbdr rbdr" style="padding:5px;text-align:right;"><?=$row_8[td]?></td>
</tr>
<tr>
<td class="left bold-text" style="padding:5px;">Admin Charge</td><td class="lbdr rbdr" style="padding:5px;text-align:right;"><?=$row_8[sc_amount]?>
</td>
</tr>
...
<?=$row_8[sc_amount]+$row_8[td]+$row_8[rep_amt]?></td>
</tr>
</tbody></table>
</td>
</tr>
...
&nbsp;<span id="lblNetAmt" style="font-size:15px;color:#990000"><b><?=$row_8[total_amt]?></b></span></td>
</tr>
<tr>
