...
<i class="fa fa-list"></i> Generate Reward
</div>
</div>
<div class="panel-body">
<form class="col-sm-6" action="reward_generation.php" method="post" name="newform" onsubmit="return validate_form(this);" >




<?
$sql_f_pair="SELECT * FROM `reward_gen` GROUP BY `endt` ORDER BY `endt` DESC";
