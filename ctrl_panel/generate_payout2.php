...
<h1>Payout</h1>
<small>Generate One India Tree Payout</small>
</div>
</section>	
...
<form class="col-sm-6" action="third_payout.php" method="post" name="newform" onsubmit="return validate_form(this);" >




<?
$sql_f_pair="SELECT * FROM `oneindia_payout` GROUP BY `endt` ORDER BY `endt` DESC";
