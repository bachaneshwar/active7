...
<i class="fa fa-list"></i> Show Reward
</div>
</div>
...
<form action="member_reward.php?lid=<?=$_REQUEST[lid]?>" method="post" name="newform" onsubmit="return validate_form(this);" >
