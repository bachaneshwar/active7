...
<h1>Payout</h1>
<small>Generate Repurchase Payout</small>
</div>
</section>	
...
<i class="fa fa-list"></i> Generate One India Tree Payout
</div>
</div>
<div class="panel-body">
<form class="col-sm-6" action="repurchase_payout.php" method="post" name="newform" onsubmit="return validate_form(this);" >




<?
$sql_f_pair="SELECT * FROM `repurchase_payout` GROUP BY `endt` ORDER BY `endt` DESC";
