...
<h1>Payout</h1>
<small>Show All Sponsor Payout</small>
</div>
</section>	
<!-- Main content -->
...
<i class="fa fa-list"></i> Show All Sponsor Payout
</div>
</div>
...
<form action="all_sponsor_payout.php" method="post" name="newform" onsubmit="return validate_form(this);" >
...
<?php
$sql="SELECT * FROM `sponsor_payout` GROUP BY `endt` ORDER BY `endt` DESC";
