...
<i class="fa fa-list"></i> Show All Reward
</div>
</div>
...
<form action="all_reward.php?lid=<?=$_REQUEST[lid]?>" method="post" name="newform" onsubmit="return validate_form(this);" >
...
<option value="" selected required>Select Reward Date</option>
<?php
$sql="SELECT * FROM `reward_generation` GROUP BY `endt` ORDER BY `endt` DESC";
