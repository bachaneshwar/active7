...
<h1>Member</h1>
<small>All One India One Tree Member </small>
</div>
</section>	
...
<i class="fa fa-list"></i> All One India One Tree Member 
</div>
</div>
...
<?php
$msgsql="select * from `oneindia_tree` ORDER BY `oneindia_tree_id` ASC  limit $lower,$upper";
...
<td style='font-size:11px'><?=$dt2?></td>
...
if($pg!=1)
print "<A HREF='stagec_member.php?pg=$pre&lid=$dtls_link[sublink_id]'class='previous-off'>&laquo; Previous</A>";
else
...
{
if($i!=$pg)
print "&nbsp;&nbsp;&nbsp;&nbsp;<A HREF='stagec_member.php?pg=$i&lid=$dtls_link[sublink_id]'>$i</A>";
else
print "&nbsp;&nbsp;&nbsp;&nbsp;$i";
}

if($pg!=$pgno)
print "&nbsp;&nbsp;&nbsp;&nbsp;<A HREF='stagec_member.php?pg=$nxt&lid=$dtls_link[sublink_id]'class='next'>Next &raquo;</A>";
else
