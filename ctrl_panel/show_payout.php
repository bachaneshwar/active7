...
<h1>Payout</h1>
<small>Income Details By Date</small>
</div>
</section>	
...
<form class="col-sm-6" action="all_daily_income.php?lid=<?=$dtls_link[sublink_id]?>" method="post" name="newform" onsubmit="return validate_form(this);" >
