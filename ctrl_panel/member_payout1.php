...
$sql_8="SELECT * FROM `global_tree_payout` WHERE `spid`='$spid' AND `endt`='$_POST[endt]'";
...
$sql8="SELECT * FROM `global_tree_payout`  WHERE `spid`='$_POST[spid]' and `endt`<='$row_8[endt]' GROUP BY `endt`";
$res8=mysqli_query($con,$sql8);
$num8=mysqli_num_rows($res8);

$sql6="SELECT * FROM `global_tree_payout`  WHERE `endt`<='$row_8[endt]' GROUP BY `endt`";
...
<a href="show_payout1.php">Back</a>
</div>
