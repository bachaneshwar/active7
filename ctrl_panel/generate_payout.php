...
<form class="col-sm-6" action="payout.php" method="post" name="newform" onsubmit="return validate_form(this);" >




<?
$sql_f_pair="SELECT * FROM `payout` GROUP BY `endt` ORDER BY `endt` DESC";
