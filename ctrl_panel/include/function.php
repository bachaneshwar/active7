<?php
session_start();
function tree_create($con,$v,$table,$id,$date,$time){
...
if($num44==0){
$sql45="INSERT `$table` (`spid`,`join_day`,`time`,`level`,`binary`)VALUES('$v','$date','$time','0','1')";
...
if($num47==0){
$sql48="INSERT `$table` (`spid`,`join_day`,`time`,`level`,`binary`,`parentspid`,`leg`)VALUES('$v','$date','$time','1','1L','$spid46','L')";
...
if($num49==0){
$sql50="INSERT `$table` (`spid`,`join_day`,`time`,`level`,`binary`,`parentspid`,`leg`)VALUES('$v','$date','$time','1','1R','$spid46','R')";
...
if($newnum22==0){
$sql50="INSERT `$table` (`spid`,`join_day`,`time`,`level`,`binary`,`parentspid`,`leg`)VALUES('$v','$date','$time','$newlev2','$newbin2','$v1','L')";
$res50=mysqli_query($con,$sql50);
}
}
else{
...
$newnum22=mysqli_num_rows($newres22);
if($newnum22==0){
$sql50="INSERT `$table` (`spid`,`join_day`,`time`,`level`,`binary`,`parentspid`,`leg`)VALUES('$v','$date','$time','$newlev2','$newbin2','$v1','R')";
$res50=mysqli_query($con,$sql50);
}
}
