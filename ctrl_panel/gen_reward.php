...
<form class="col-sm-6" action="reward_gen.php" method="post" name="newform" onsubmit="return validate_form(this);" >




<?
$sql_f_pair="SELECT * FROM `reward_generation` GROUP BY `endt` ORDER BY `endt` DESC";
