...
if($_GET[sub]==2){
?>
<a id="btnPrint" class="positive" usesubmitbehavior="False" href="welcome_letter.php">Back</a>
<? } else { ?>
<a id="btnPrint" class="positive" usesubmitbehavior="False" href="joining.php">Back</a>
<? } ?>
</div>
