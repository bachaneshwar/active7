...
<h1>Payout</h1>
<small>Show All Repurchase Payout</small>
</div>
</section>	
<!-- Main content -->
...
<i class="fa fa-list"></i> Show All Repurchase Payout
</div>
</div>
...
<form action="all_payout3.php" method="post" name="newform" onsubmit="return validate_form(this);" >
...
<?php
$sql="SELECT * FROM `repurchase_payout` GROUP BY `endt` ORDER BY `endt` DESC";
