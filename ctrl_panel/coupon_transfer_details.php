...
<h1>Coupon</h1>
<small>Transfer Details By Date</small>
</div>
</section>	
...
<form class="col-sm-6" action="coupon_transfer_report.php?lid=<?=$dtls_link[sublink_id]?>" method="post" name="newform" onsubmit="return validate_form(this);" >
