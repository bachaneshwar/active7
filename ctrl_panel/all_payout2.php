...
$sql="SELECT * FROM `oneindia_payout`  WHERE `endt`='$_REQUEST[endt]' GROUP BY `endt`";
...
<title>One India Tree Payout Report From <?=$row[stdt]?> To <?=$row[endt]?></title>
...
<div class="">
<h1>One India Tree Payout Report From <?=$row[stdt]?> To <?=$row[endt]?></h1>
...
$sel1 = "select * from `oneindia_payout` WHERE `endt`='$_REQUEST[endt]'  AND `total_amt`!='0' ORDER BY `payout_id` ASC";
...
<center> <a style='text-decoration:none;font-size:20px'  href="show_all_payout2.php">BACK</a> </center>
