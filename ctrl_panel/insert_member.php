...
include("include/trinary_function_team.php");
...
header("location:joining_letter.php?spid=$spid") ;



}else{
header("location:joining.php?msg=Sponsor Id is not valid.") ;
}
