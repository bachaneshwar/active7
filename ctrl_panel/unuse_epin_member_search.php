...
//
// if($numspid>0){
// echo '<META HTTP-EQUIV="Refresh" Content="0; URL=unuse_epin_member.php?spid='.$_POST[spid].'">';
// }
// else{
...
<form action="unuse_epin_member.php" method="post" name="newform" class="col-sm-6" onsubmit="return validate_form(this); " >
...
<input type="text" name="start_date"  id="start_date" value='' class="form-control" size="10" readonly  />
...
<input type="text" name="end_date"  id="end_date" value='' class="form-control" size="10" readonly  />
