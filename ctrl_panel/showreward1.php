...
<h1>Member</h1>
<small>Member Details By Date</small>
</div>
</section>
...
<form class="col-sm-6" action="member_report1.php" method="post" name="newform" onsubmit="return validate_form(this);" >
<div class="form-group">
<label>Start Date</label>
<input type="text" name="start_date"  id="start_date" value='<?=$_REQUEST['date']?>' class="form-control" size="20" readonly  />
...
<input type="text" name="end_date"  id="end_date" value='<?=$_REQUEST['date']?>' class="form-control" size="20" readonly  />
