...
$sql="SELECT * FROM `repurchase_payout`  WHERE `endt`='$_REQUEST[endt]' GROUP BY `endt`";
...
<title>Stage A Payout Report From <?=$row[stdt]?> To <?=$row[endt]?></title>
...
<div class="">
<h1>Stage A Payout Report From <?=$row[stdt]?> To <?=$row[endt]?></h1>
...
<th style='font-size:13px;border:1px solid black;font-weight:bold;text-align:center'>Self</th>
<th style='font-size:13px;border:1px solid black;font-weight:bold;text-align:center'>Team</th>
...
$sel1 = "select * from `repurchase_payout` WHERE `endt`='$_REQUEST[endt]'  AND `total_amt`!='0' ORDER BY `payout_id` ASC";
...
$direct_income+=$row_pay[direct_income];
$downline_income+=$row_pay[downline_income];
...
<td style='font-size:13px;border:1px solid black;text-transform:uppercase'><?=$row_pay[direct_income]?></td>
<td style='font-size:13px;border:1px solid black;text-transform:uppercase'><?=$row_pay[downline_income]?></td>
...
<td style='font-size:13px;border:1px solid black;text-transform:uppercase'></td>
<td style='font-size:13px;border:1px solid black;text-transform:uppercase'><?=$direct_income?></td>
<td style='font-size:13px;border:1px solid black;text-transform:uppercase'><?=$downline_income?></td>
...
<center> <a style='text-decoration:none;font-size:20px'  href="show_all_payout3.php">BACK</a> </center>
