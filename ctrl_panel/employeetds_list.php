...
<form class="col-sm-6" action="employee_all_tds.php?lid=<?=$dtls_link[sublink_id]?>" method="post" name="newform" onsubmit="return validate_form(this);" >
