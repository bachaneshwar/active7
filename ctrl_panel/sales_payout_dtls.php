...
<h1>Payout</h1>
<small>Show All Sales Payout</small>
</div>
</section>	
<!-- Main content -->
...
<form action="all_sales_payout.php" method="post" name="newform" onsubmit="return validate_form(this);" >
...
<?php
$sql="SELECT * FROM `sales_payout` GROUP BY `endt` ORDER BY `endt` DESC";
