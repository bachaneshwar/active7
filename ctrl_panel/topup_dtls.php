...
<h1>Join Package</h1>
<small>Join Details By Date</small>
</div>
</section>	
...
<form class="col-sm-6" action="topup_report.php?lid=<?=$dtls_link[sublink_id]?>" method="post" name="newform" onsubmit="return validate_form(this);" >
