...
$sql1="SELECT * FROM `employee` WHERE `employee_id`='$_SESSION[employee_id]'";
$res1=mysqli_query($con,$sql1);
$row1=mysqli_fetch_array($res1);
$pass=$row1[employee_pwd];

$old_pass=md5($_POST[old_pass]);

if($old_pass==$pass){
$encode_value=md5($_POST[pass]);
$sql="UPDATE `employee` SET `employee_pwd`='$encode_value' WHERE `employee_id`='$_SESSION[employee_id]'";
