...
$sql="INSERT INTO `global_tree_payout` (`stdt`,`endt`,`payout_date`,`spid`,`commission`,`td`,`sc_amount`,`total_amt`)
VALUES ('".$_SESSION[stdt][$k]."','".$_SESSION[endt][$k]."','".$_SESSION[ptdt][$k]."','$v','".$_SESSION[one_india_income][$k]."','".$_SESSION[td][$k]."','".$_SESSION[sc][$k]."','".$_SESSION[total_amt][$k]."')";
...
if($res){
header("location:generate_payout1.php?msg=Payout Sucessfully Generated.");
}
