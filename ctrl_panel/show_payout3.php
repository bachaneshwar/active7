...
<h1>Payout</h1>
<small>Show Repurchase Payout</small>
</div>
</section>	
<!-- Main content -->
...
<i class="fa fa-list"></i> Show Repurchase Payout
</div>
</div>
...
<form action="member_payout3.php" method="post" name="newform" onsubmit="return validate_form(this);" >
