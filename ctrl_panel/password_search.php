...
if($numspid>0){	
$nurl="password_search.php?pg=$_GET[pg]&lid=$dtls_link[sublink_id]&spid=$_POST[spid]&sub=2&";
...
$nurl="password_search.php?pg=$_GET[pg]&lid=$dtls_link[sublink_id]&sub=2&";
...
<i class="fa fa-list"></i> Password Details
</div>
</div>
...
<td><?=$member_det[pass]?></td>
</tr>

<tr ><td colspan="2"><br/></td></tr>

<tr>
<td >E-Pin Password:</td>
<td><?=$member_det[epin_password]?></td>
</tr>
...
<td><?=$member_det[trans_password]?></td>
</tr>	
