...
<h1>E-Wallet</h1>
<small>Ewallet Debit Details By Date</small>
</div>
</section>	
...
<form class="col-sm-6" action="ewallet_debit_report.php" method="post" name="newform" onsubmit="return validate_form(this);" >
