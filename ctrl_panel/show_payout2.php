...
<h1>Payout</h1>
<small>Show One India Tree Payout</small>
</div>
</section>	
<!-- Main content -->
...
<i class="fa fa-list"></i> Show Payout
</div>
</div>
...
<form action="member_payout2.php" method="post" name="newform" onsubmit="return validate_form(this);" >
...
<?php
$sql="SELECT * FROM `oneindia_payout` GROUP BY `endt` ORDER BY `endt` DESC";
