...
$sql="INSERT INTO `oneindia_payout` (`stdt`,`endt`,`payout_date`,`spid`,`commission`,`td`,`sc_amount`,`total_amt`)
...
if($res){
header("location:generate_payout2.php?msg=Payout Sucessfully Generated.");
}
