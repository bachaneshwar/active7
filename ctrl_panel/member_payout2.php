...
$sql_8="SELECT * FROM `oneindia_payout` WHERE `spid`='$spid' AND `endt`='$_POST[endt]'";
...
$sql8="SELECT * FROM `oneindia_payout`  WHERE `spid`='$_POST[spid]' and `endt`<='$row_8[endt]' GROUP BY `endt`";
$res8=mysqli_query($con,$sql8);
$num8=mysqli_num_rows($res8);

$sql6="SELECT * FROM `oneindia_payout`  WHERE `endt`<='$row_8[endt]' GROUP BY `endt`";
...
<tr>
<td class="left bold-text lbdr" style="padding:5px;">Commission</td><td class="lbdr rbdr" style="padding:5px;text-align:right;">
<?=$row_8[commission]?></td>
</tr>
<tr>
...
<a href="show_payout2.php">Back</a>
</div>
