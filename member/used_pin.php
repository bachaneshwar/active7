...
<div class="row">
    ...
    <h1 class="dash-title">Used E-Pin</h1>
    <!-- //////////////////////////////////////////////////// Breadcrumb -->
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-home" aria-hidden="true"></i> E-Pin </a></li>
          <li><a href="#" class="active">Used E-Pin</a></li>
        </ol> <!-- /breadcrumb -->
    </div> <!-- /dashboard -->
</div> <!-- /row -->
...
<th scope="col" class="rounded">Used Date</th>
<th scope="col" class="rounded">Used By</th>
...
<?php
$msgsql="select * from `e-pin` WHERE `status`='0'  AND `memtransid`='$_SESSION[spid]'  ORDER BY `id` ASC";
$msgres=mysqli_query($con,$msgsql);
while($row=mysqli_fetch_array($msgres)){
$c++;


$dt1=explode("-",$row[useddate]);
