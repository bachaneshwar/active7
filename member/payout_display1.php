...
<div class="row">
    ...
    <!-- //////////////////////////////////////////////////// Breadcrumb -->
        <ol class="breadcrumb">
          ...
          <li><a href="#" class="active">Global Tree Payout Details</a></li>
        </ol> <!-- /breadcrumb -->
    </div> <!-- /dashboard -->
</div> <!-- /row -->
...
$sql7="SELECT * FROM `global_tree_payout`  WHERE `spid`='$_SESSION[spid]' AND `total_amt`!='0' ORDER BY  `payout_id` DESC";
