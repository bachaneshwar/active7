...
<head>
    ...
    <!-- Theme Style-->
    <link rel="stylesheet" id="jssDefault" type="text/css" href="css/theme-purple.css"> 
...
<div class="container-fluid">
    ...
    <a class="navbar-brand" href="dashboard.php?m=1">
        <span class="logo-img"><!-- logo img <img src="img" alt=""> --></span>
...
-->
     ...
     <!--   <img src="img/admin.jpg" alt="" class="profile-img img-circle img-resposnive pull-left"> -->
        ...
        <span class="hidden-xs"><?=$row[sname]?></span> <span class="caret"></span></a>
