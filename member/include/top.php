...
<head>
   ...
   Member Panel</title>
    ...
    <![endif]-->
	   	   ...
	   	   <!-- calender -->
  <script type='text/javascript' src="../ctrl_panel/zpcal/utils/zapatec.js"></script>
<!-- Custom includes -->
<!-- import the calendar script -->
<script type="text/javascript" src="../ctrl_panel/zpcal/src/calendar.js"></script>
<!-- import the language module -->
<script type="text/javascript" src="../ctrl_panel/zpcal/lang/calendar-en.js"></script>
<!-- other languages might be available in the lang directory; please check
your distribution archive. -->
<!-- ALL demos need these css -->
<link href="../ctrl_panelzpcal/website/css/zpcal.css" rel="stylesheet" type="text/css">
<!--<link href="../ctrl_panel/zpcal/website/css/template.css" rel="stylesheet" type="text/css">-->
<link href="../ctrl_panel/zpcal/themes/aqua.css" rel="stylesheet" type="text/css">
<script language="javascript" src="../ctrl_panel/js/validation.js"></script>
  <!-- end calender -->
...
#grad1 {
  height: 170px;
  background-color: #9d00ff; /* For browsers that do not support gradients */
  background-image: linear-gradient(#9d00ff, #d800ff); /* Standard syntax (must be last) */
}
#grad2 {
  height: 170px;
  background-color: #5290e7; /* For browsers that do not support gradients */
  background-image: linear-gradient(#5290e7, #26d4df); /* Standard syntax (must be last) */
}
#grad3 {
  height: 170px;
  background-color: #06af9a; /* For browsers that do not support gradients */
  background-image: linear-gradient(#06af9a, #8ec742); /* Standard syntax (must be last) */
}
#grad4 {
  height: 170px;
  background-color: #e63f59; /* For browsers that do not support gradients */
  background-image: linear-gradient(#e63f59, #f1a019); /* Standard syntax (must be last) */
}
...
<div class="container-fluid" style="background-color:#f2a11a;">

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div id="navbar-header">

      <a class="navbar-brand" href="dashboard.php?m=1">
          <!-- <span class="logo-img">logo img <img src="img" alt=""> SM</span> -->
          <span class="logo-text hidden-xs hidden-sm"></span>
      </a> <!-- /navbar-brand -->
...
-->
      ...
      <!-- /navbar-form -->
        ...
        <span style="color:brown;font-size:25px;font-family:'Times New Roman', Times, serif;font-weight:bold"><?=$_SESSION[spid]?></span>
      ...
      <!--  <img src="img/admin.jpg" alt="" class="profile-img img-circle img-resposnive pull-left"> -->
        ...
        <span class="hidden-xs">Welcome <br/> <?=$row[sname]?></span> <span class="caret"></span></a>

        <ul class="dropdown-menu pull-right">
            <li><a href="profile_settings.php?m=1"><i class="fa fa-user" aria-hidden="true"></i>Profile</a></li>
            <li><a href="dashboard.php?m=0"><i class="fa fa-home" aria-hidden="true"></i>Dashboard</a></li>
