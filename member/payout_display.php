...
<div class="row">
    ...
    <!-- //////////////////////////////////////////////////// Breadcrumb -->
        <ol class="breadcrumb">
          ...
          <li><a href="#" class="active">Payout Details</a></li>
        </ol> <!-- /breadcrumb -->
    </div> <!-- /dashboard -->
</div> <!-- /row -->
...
<td align="center"><b>Matching Income<b></th>
...
$sql7="SELECT * FROM `payout`  WHERE `spid`='$_SESSION[spid]' AND `total_amt`!='0' ORDER BY  `payout_id` DESC";
$res7=mysqli_query($con,$sql7);
while($row7=mysqli_fetch_array($res7)){
	$c++;
	$deduct=$row7[td]+$row7[sc_amount]+$row7[draft_charge]+$row7[rep_amt];
	
$sponsor_income+=$row7[sponsor_income];
$binary_income+=$row7[binary_income];
$self_income+=$row7[self_income];
$leader_ship_income+=$row7[leader_ship_income];
$td+=$row7[td];
