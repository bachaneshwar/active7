...
if($vrow[member_status]=="0"){
$img="images/thumb/red.png";
}
elseif($vrow[member_status]=="1"){
$img="images/thumb/green.png";
}
elseif($vrow[member_status]=="2"){
...
$first_sel_left_calc1="Select * from `$table` bin WHERE `binary` LIKE '$left_pt%' AND `member_status`='1'";
...
$first_sel_right_calc1="Select * from `$table` bin WHERE `binary` LIKE '$right_pt%' AND `member_status`='1'";
...
<h1 class="dash-title">Carry Forward Matching Tree</h1>
<!-- //////////////////////////////////////////////////// Breadcrumb -->
<ol class="breadcrumb">
...
<form action="carry_genealogy.php" method="POST" >
...
if($step1[spid]!=""){
?>
<a href="carry_genealogy.php?tree_id=<?=$_REQUEST[tree_id]?>&id=<? print $id=base64_encode($step1[spid])?>" onmouseover="ajax_showTooltip(window.event,'demo-pages/carry_genealogy.php?tree_id=<?=$_REQUEST[tree_id]?>&spid=<?=$step1[spid]?>',this);return false" onmouseout="ajax_hideTooltip()">
...
if($spid!=""){
?>
<a href="carry_genealogy.php?tree_id=<?=$_REQUEST[tree_id]?>&id=<? print $id=base64_encode($spid)?>" onmouseover="ajax_showTooltip(window.event,'demo-pages/carry_genealogy.php?tree_id=<?=$_REQUEST[tree_id]?>&spid=<?=$spid?>',this);return false" onmouseout="ajax_hideTooltip()">
...
if($spid!=""){
?>
<a href="carry_genealogy.php?tree_id=<?=$_REQUEST[tree_id]?>&id=<? print $id=base64_encode($spid)?>" onmouseover="ajax_showTooltip(window.event,'demo-pages/carry_genealogy.php?tree_id=<?=$_REQUEST[tree_id]?>&spid=<?=$spid?>',this);return false" onmouseout="ajax_hideTooltip()"><span style="font-size:11px;"><?=$spid?></span><br/>
