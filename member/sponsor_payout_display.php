...
<div class="row">
    ...
    <h1 class="dash-title">Sponsor Payout</h1>
    <!-- //////////////////////////////////////////////////// Breadcrumb -->
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-home" aria-hidden="true"></i> Benefit</a></li>
          <li><a href="#" class="active">Sponsor  Payout</a></li>
        </ol> <!-- /breadcrumb -->
    </div> <!-- /dashboard -->
</div> <!-- /row -->
...
<?php
 ...
 $sql7="SELECT * FROM `sponsor_payout`  WHERE `spid`='$_SESSION[spid]' AND `total_amt`!='0'";
